	...
	t.Run("lint - PR comment", func(t *testing.T) {
		...
		ghMock := httptest.NewServer(http.HandlerFunc(func(writer http.ResponseWriter, request *http.Request) {
			...
			case path == "/repos/test-owner/test-repository/issues/42/comments" && method == http.MethodPost:
				...
				return
			case path == "/repos/test-owner/test-repository/pulls/42/files" && method == http.MethodGet:
				_, err := writer.Write([]byte(`[{"filename": "testdata/path/to/file1.go"}, {"filename": "testdata/path/to/file2.go"}]`))
				require.NoError(t, err)
				return
			case path == "/repos/test-owner/test-repository/pulls/42/comments" && method == http.MethodGet:
				var payload []map[string]any
		...
		require.Equal(t, map[string]any{
			"id":         2,
			"body":       "Table t3 must have a primary key\n<!-- generated by ariga/atlas-action for schema-lint:testdata/path/to/file1.go:10-0:Table t3 must have a primary key -->",
			"path":       "testdata/path/to/file1.go",
			"start_line": float64(10),
			"line":       float64(10),
		}, reviewComments[2])
		require.Equal(t, map[string]any{
			"id":         3,
			"body":       "Table t4 must have a primary key\n<!-- generated by ariga/atlas-action for schema-lint:testdata/path/to/file2.go:10-20:Table t4 must have a primary key -->",
			"path":       "testdata/path/to/file2.go",
			"start_line": float64(10),
			"line":       float64(20),
		}, reviewComments[3])
		// Rerun schema lint
		...
		require.Equal(t, map[string]any{
			"id":         4,
			"body":       "Table t5 must have a primary key\n<!-- generated by ariga/atlas-action for schema-lint:testdata/path/to/file2.go:30-40:Table t5 must have a primary key -->",
			"path":       "testdata/path/to/file2.go",
